...
@section("title") Sub Category Level3 || edit @endsection
@section("content")
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Sub Category Level3</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{route('categorylevel3.index')}}">Sub Category Level3</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 m-auto">
                        ...
                        <div class="card">
                            <!-- form start -->
                            <form class="form" action="{{route('categorylevel3.update', $category->id)}}" method="POST" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="card-body row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label for="category_level1_id">Main Category</label>
                                                <select class="form-control @error('category_level1_id') is-invalid @enderror " id="category_level1_id" name="category_level1_id">
                                                    @foreach($maincategories as $maincategory)
                                                        <option value="{{$maincategory->id}}" @if($category->category_level1_id == $maincategory->id) selected @endif >{{$maincategory->name}} [ {{$maincategory->subCategory->name}} ][ {{$maincategory->subCategory->mainCategory->name}} ]</option>
                                                    @endforeach
                                                </select>
                                                @error('category_level1_id')
                                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                                @enderror
