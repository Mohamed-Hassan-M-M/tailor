...
@section("title") Sub Category Level3 || create @endsection
@section("content")
                ...
                <div class="row">
                    <div class="col-md-12 m-auto">
                        ...
                        <div class="card">
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form" action="{{route('categorylevel3.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control @error('category_level1_id') is-invalid @enderror " id="category_level1_id" name="category_level1_id">
                                            ...
                                            <option value="{{$category->id}}">{{$category->name}} [ {{$category->subCategory->name}} ][ {{$category->subCategory->mainCategory->name}} ]</option>
                                            @endforeach
                                        </select>
