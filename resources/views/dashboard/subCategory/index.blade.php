    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <a class="btn btn-lg btn-primary mb-3" href="{{route('sub-category.create')}}"><i class="fa fa-plus"></i> Add Sub Category </a>
                    </div>
                </div>
                                        ...
                                        @foreach($categories as $category)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{route('sub-category.edit',$category->id)}}" class="mr-2"><i class="fa fa-edit text-success"></i></a>
