...
@section("title") Main Category @endsection
@section("content")
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <a class="btn btn-lg btn-primary mb-3" href="{{route('main-category.create')}}"><i class="fa fa-plus"></i> Add Main Category </a>
                    </div>
                </div>
                                ...
                                <table id="example" class="table table-striped table-bordered table-hover text-center" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="{{route('main-category.edit',$category->id)}}" class="mr-2"><i class="fa fa-edit text-success"></i></a>
                                            <a href="" class="mr-2 delete" ><i class="fa fa-trash text-danger"></i></a>
                                            <form method="POST" action="{{route('main-category.destroy', $category->id) }}" >
                                            @method('DELETE')
                                            @csrf
                                            </form>
                                        </td>
