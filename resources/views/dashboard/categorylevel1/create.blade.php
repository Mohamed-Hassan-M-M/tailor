...
@section("title") Sub Category Level2 || create @endsection
@section("content")
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('categorylevel2.index')}}">Sub Category Level2</a></li>
                ...
                <div class="row">
                    <div class="col-md-12 m-auto">
                        ...
                        <div class="card">
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form" action="{{route('categorylevel2.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
